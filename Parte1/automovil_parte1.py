class Vehiculo():
    ...
    def __str__(self):
        return  f"Marca : {self.marca}, Modelo : {self.modelo}, {self.numero_de_ruedas} ruedas, {self.velocidad},"
...
class Automovil(Vehiculo):
    ...
    def __str__(self):
        return  f"Marca : {self.marca}, modelo : {self.modelo}, {self.numero_de_ruedas} ruedas, {self.velocidad}, cilindrada : {self.cilindrada}"
